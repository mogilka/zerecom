...
* @File:                ru_RU.php
* @Package:             GetSimple
* @Subject:             Russian language file
* @Date:                19 January 2010
* @Version:             GetSimple 2.0
* @Status:              1.0
* @Translator:  Stanislav Ulver (vsky) - www.designskill.org    
*
*****************************************************/
...
"CHMOD_ERROR"                   =>      "<b>Невозможно продолжить:</b> Не удалось создать конфигурационный файл. Убедитесь что у папок /data/ и /backups/ (и их под-папок) есть права доступа CHMOD 777, а затем повторите попытку",
...
"MSG_PLEASE"                    =>      "Пожалуйста авторизируйтесь, чтобы получить доступ к своему аккаунту",
...
"LOGIN_REQUIREMENT"             =>      "Требования авторизации",
"WARN_JS_COOKIES"               =>      "Включенные cookies и javascript для корректной работы сайта",
"WARN_IE6"                              =>      "Система может некорректно работать в Internet Explorer 6",
...
"EMAIL_ON_404"                  =>      "Оповещать администратора об ошибках 404",
"VIEW_404"                              =>      "Просмотреть ошибки 404",
"VIEW_FAILED_LOGIN"             =>      "Просмотреть ошибки авторизации",
"VIEW_CONTACT_FORM"             =>      "Просмотреть контакты через форму",
"VIEW_TICKETS"                  =>      "Просмотреть Ваши сохраненные тикеты",
 ...
 * For: contactform.php
*/
"MSG_CAPTCHA_FAILED"    =>      "Ошибка captcha, мы думаем что вы спам бот",
"CONTACT_FORM_SUB"              =>      "Отправка контактной формы",
"FROM"                                  =>      "от",
"MSG_CONTACTSUC"                =>      "Ваш e-mail успешно отправлен",
"MSG_CONTACTERR"                =>      "Возникла проблема при отправке e-mail",

/*
 * For: 404-mailer.php
*/
"404_ENCOUNTERED"               =>      "Авто: Ошибка 404 произошла на",
"404_AUTO_MSG"                  =>      "Это автоматическое сообщение с сайта",
"PAGE_CANNOT_FOUND"             =>      "Ошибка 'страница не найдена' произошла на",
"DOMAIN"                                =>      "домен",
"DETAILS"                               =>      "ПОДРОБНОСТИ",
"WHEN"                                  =>      "Когда",
"WHO"                                   =>      "Кто",
"FAILED_PAGE"                   =>      "Ошибочная страница",
"REFERRER"                              =>      "Реферер",
"BROWSER"                               =>      "Браузер",
...
"SUBMIT_TICKET"                 =>      "Сохранить тикет",

/*
 * For: backups.php
*/
"PAGE_BACKUPS"                  =>      "Бэкап страниц",
...
"SIDE_SUBMIT_TICKET"    =>      "Сохранить тикет",
...
"CLIPBOARD_COPY"                =>  "Скопировать в буфер обмена",
"CLIPBOARD_INSTR"               =>  "Выделить все, затем <em>ctrl-c</em> или <em>command-c</em>",
"CREATE_THUMBNAIL"              =>  "Создать миниатюру",
"CROP_INSTR"                    =>  "Удерживать <em>ctrl-Q</em> или <em>command-Q</em> для квадрата",
